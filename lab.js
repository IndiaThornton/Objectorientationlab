...
const max = new Cat('Max', 3, 'Calico' )
...
const Robert = new Wizard('Robert', 15, 'Expecto Patronum')
...
//Code Here
let phoneOne = new Phone('Apple', 'iPhone', 256, 'black', 700)
let phoneTwo = new Phone('Samsung', 'Galaxy', 256, 'black', 1200)
let phoneThree = new Phone('Google', 'Pixel', 128, 'black', 800)
/* 
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(2, 'black', 2000, 'CanAm', true)
/*
...
//Code Here
const myFirstBoat = new Boat(10, 'red', 20000, 'SeaDo 58', 'dingy', false)
/*
